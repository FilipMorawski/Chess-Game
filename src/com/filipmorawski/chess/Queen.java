...
public class Queen extends Figure {
	...
	void setPossibleMoves() {
		...
		// Queen movements is a sum of Courier and Tower moves - so I create
		// objects of Tower and Courier
		// with as same as Queen position parameter, and they pass to Queen
		// theirs possible moves
		...
		towerPossibleMoves = new Tower(this.name, this.color, this.position, this.verticalID, this.horizontalID)
				.getPossibleMoves();
		courierPossibleMoves = new Courier(this.name, this.color, this.position, this.verticalID, this.horizontalID)
				.getPossibleMoves();

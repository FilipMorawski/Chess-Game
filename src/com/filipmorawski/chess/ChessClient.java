...
public class ChessClient {
	...
	public void start() {
		...
		if (this.socket.isConnected()) {
			...
			JOptionPane.showMessageDialog(null, "Succesfully connected to server", "Connection estabilished",
		...
		if (start) {
			...
			JOptionPane.showMessageDialog(null, ("You're playing with " + color + " , let's start!"), "Let's start!",
					JOptionPane.INFORMATION_MESSAGE);
		}

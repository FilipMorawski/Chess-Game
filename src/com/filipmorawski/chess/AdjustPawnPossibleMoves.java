...
public class AdjustPawnPossibleMoves extends AdjustPossibleMoves {
	...
	void adjustMoves(String name, String position) {
		...
		if (this.color == 1) {
			...
			if ((position.equals(firstLetter + 2)) && (Figures.figuresPositionMap.contains(firstLetter + "3")
					|| Figures.figuresPositionMap.contains(firstLetter + "4"))) {
		...
		if (this.color == 2) {
			...
			if ((position.equals(firstLetter + 7)) && (Figures.figuresPositionMap.contains(firstLetter + "6")
					|| Figures.figuresPositionMap.contains(firstLetter + "5"))) {
